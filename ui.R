...
shinyUI(fluidPage(
  ...
  h6("We use two different packages in R to do almost the same analysis."),
  h6("The functions in R use different algorithm to correct"),
  h6("mispelling or sinonyms of flora."),
  h3("Why Plant list?"),
  ...
  fluidRow(
    ...
    column(4,h5("All sample points (dots) come from iNaturalist database"),
      column(12,leafletOutput("mymap",height=800))
      #h4("Citation of rinat package:"),
      #h6("Citation: : Vijay Barve and Edmund Hart (2014). rinat: Access iNaturalist data through APIs."), 
      #h6("R package version 0.1.4."),    
      #h6("http://CRAN.R-project.org/package=rinat")
      )
